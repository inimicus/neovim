...
wk.register({
    ...
    b = {
        ...
        d = {"<cmd>lua require('bufdelete').bufdelete(0, false)<CR>", "Delete Buffer"},
        D = {"<cmd>lua require('bufdelete').bufdelete(0, true)<CR>", "Delete Buffer (Force)"},
    ...
    f = {
        ...
        f = {"<cmd>Telescope find_files find_command=rg,--hidden,--files,-S<cr>", "Find Files"},
    ...
    g = {
        ...
        B = {"<cmd>lua require 'gitsigns'.toggle_current_line_blame()<cr>", "Toogle Blame"},
        ...
        l = {"<cmd>lua require 'gitsigns'.toggle_linehl()<cr>", "Toggle Line Diff"},
        n = {"<cmd>lua require 'gitsigns'.toggle_numhl()<cr>", "Toggle Num Diff"},
    ...
    [";"] = {"<cmd>lua require('leap').leap({target_windows = {vim.fn.win_getid()}})<cr>", "Leap Bidirectional"},
