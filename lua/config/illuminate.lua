...
-- cmd[[hi def IlluminatedWordText guifg=#C8C093 guibg=#363646]]
--
-- Highlight group used for references of kind read.
-- cmd[[hi def IlluminatedWordRead guifg=#C8C093 guibg=#363646]]
--
-- Highlight group used for references of kind write.
-- cmd[[hi def IlluminatedWordWrite guifg=#C8C093 guibg=#363646]]
